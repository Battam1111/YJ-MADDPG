...
from hgam.replay.memory import ReplayMemory
from hgam.nn.nets import HeteroMAGNet
from hgam.nn.action_layers import HeteroMAGNetActionLayer
from hgam.nn.gat import GATModule
from hgam.replay.epsilon_schedules import DecayThenFlatSchedule
from hgam.replay.replay import ReplayBuffer, Transition
# from hgam.training.trainer import TrainingConfig  # unused; commented to avoid tqdm dep
from hgam.nn.nets import MADDPGAgent
from hgam.env.ou_noise import OUNoise
from hgam.utils._legacy_utils import get_load_path
...
class MADDPGController(ABC):
    ...
    def update(self, i_step, param_dict: dict):
        ...
        is_weight_batch = is_weight_batch.to(self.device)
        n_step_batch = n_step_batch.to(self.device)
