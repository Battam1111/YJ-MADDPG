...
class Drone(object):
    ...
    def __init__(self, basePos: list = [0., 0., 0.], sence_loadItems: dict = None, signalPointId2data: dict = None, 
        ...
        self.device = device
        # 从配置文件加载参数
        for file in os.listdir("hcanet-3.27_maddpg-MAAC/config"):
            path = os.path.join("hcanet-3.27_maddpg-MAAC/config", file)
...
if __name__ == "__main__":
    ...
    # 请确保配置文件 hcanet-3.27_maddpg-MAAC/config 中有正确的参数设置
